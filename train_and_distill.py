...
from models.score import edge_prediction_metric
...
model_path = r'....\ckpt\ellipticpp_anomaly.pth.tar'
...
loss_test, loss_test_ext, loss_component_test, npred_metric_test, epred_metric_test, cg_data_test = eval(args["n_epoch"])
